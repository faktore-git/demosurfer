 ...
 * PATCHED: Can use a config option "composerJsonPath" to use a NON-project-root folder
 */
class InstallTask extends Task implements ShellCommandServiceAwareInterface
{
